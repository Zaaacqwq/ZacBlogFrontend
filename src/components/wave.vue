...
.parallax .use:nth-child(4) {
    ...
    fill: #eee; /* Replace with actual color value */
}

.parallax .use:nth-child(3) {
    animation-delay: -3s;
    animation-duration: 10s;
    fill: #ddd; /* Replace with actual color value */
}

.parallax .use:nth-child(2) {
    animation-delay: -4s;
    animation-duration: 13s;
    fill: #ccc; /* Replace with actual color value */
}

.parallax .use:nth-child(1) {
    animation-delay: -5s;
    animation-duration: 20s;
    fill: #bbb; /* Replace with actual color value */
}
