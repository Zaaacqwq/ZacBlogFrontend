                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <el-upload
                              ...
                              <img   v-if="userInfoObj.avatar" :src="userInfoObj.avatar?userInfoObj.avatar:'aki-min.png'"  :onerror="$store.state.errorImg" class="avatar">
                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <div class="avatar-uploader">
                                <img  :src="userInfoObj.avatar?userInfoObj.avatar:'aki-min.png'"   :onerror="$store.state.errorImg" class="avatar">
                            </div>
                        </li>
                        <li class="username">
                            <span class="leftTitle">昵称</span>
